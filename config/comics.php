...
return [
    'comics' => [
        [
            "title" => "Action Comics characters1000: The Deluxe Edition",
            "description" => "The celebration of 1,000 issues of Action Comics continues with a new, Deluxe Edition of the amazing comic that won raves when it hit comics shops in April! This hardcover includes all the stories from that issue, plus the tale by writer Paul Levitz and artist Neal Adams that appeared in the Action Comics: 80 Years Of Superman hardcover, as well as all the variant covers, design sketches by Jim Lee for Superman’s new look, scripts for the stories, the original art from the lost story featuring art by Curt Swan and more! Plus: a complete reprint of the stories that started it all—the Superman stories Action Comics characters1 and 2 from 1938!",
        ...
        [
            "title" => "American Vampire 1976 characters1",
        ...
        [
            "title" => "Batman Beyond characters1",
        ...
        [
            "title" => "Batman/Superman characters1",
        ...
        [
            "title" => "Batman/Superman Annual characters1",
        ...
        [
            "title" => "Batman: The Joker War Zone characters1",
        ...
        [
            "title" => "Batman: White Knight Presents: Harley Quinn characters1",
